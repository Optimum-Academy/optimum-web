  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
               <h1 className="font-heading text-4xl sm:text-5xl font-bold tracking-tight text-slate-900 mb-8">
                 {cmsPage?.title || 'Empowering Careers in Community Care.'}
               </h1>
               <div
                 className="text-xl text-slate-600 leading-relaxed prose prose-xl max-w-none"
                 dangerouslySetInnerHTML={{ __html: cmsPage?.content || `
                   <p>Optimum Academy was founded with a clear mission: to bridge the skills gap in Australia’s care and support sectors by providing high-quality, industry-focused vocational training.</p>
                 ` }}
               />
            </div>
          </div>
        ...
        {/* Mission/Vision - Only show if no CMS content or if explicitly wanted */}
        {!cmsPage && (
          <>
