        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative lg:h-[600px]">
             ...
             <div className="w-full h-full min-h-[400px] rounded-3xl bg-slate-100 relative overflow-hidden shadow-2xl">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1556761175-b413da4baf72?q=80&w=2000')] bg-cover bg-center mix-blend-overlay opacity-80" />
